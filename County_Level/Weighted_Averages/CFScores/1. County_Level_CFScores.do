...
import delimited "$path\Data\Cleaned\contribs_cf_combined.csv", varnames(1) clear
...
export delimited "$path\Data\Cleaned\contribs_cf_combined.csv", replace
...
save "$path\Data\Output\contribs_cf_combined"
...
* Final Merge.
sort week fips
merge 1:1 week fips using "$path\Data\Output\contribs_cf_combined"
...
save "$path\Data\Output\contribs_cf_combined_matched", replace
