...
output <- 'C:/Users/anjun/OneDrive/Desktop/EP/DIME/DIME_Data/Output/ZIP_Level/Quantiles'
##################
...
for(i in 3:length(cycles)) {
  ...
  LCV_scores <- LCV_scores %>%
    group_by(Year) %>%
    mutate('top10perc_val' = quantile(Nominal.Score, 0.9),
           'bottom10perc_val' = quantile(Nominal.Score, 0.1),
           'top25perc_val' = quantile(Nominal.Score, 0.75),
           'bottom25perc_val' = quantile(Nominal.Score, 0.25)) %>%
    mutate('top10perc_ind' = (Nominal.Score >= top10perc_val),
           'bottom10perc_ind' = (Nominal.Score < bottom10perc_val),
           'top25perc_ind' = (Nominal.Score >= top25perc_val),
           'bottom25perc_ind' = (Nominal.Score < bottom25perc_val)) %>%
    ungroup() %>%
    as.data.table()
  ...
  top10perc_cands <- LCV_scores[top10perc_ind == TRUE, .(ICPSR, Year, indicator_top_10perc = 1)]
  bottom10perc_cands <- LCV_scores[bottom10perc_ind == TRUE, .(ICPSR, Year, indicator_bottom_10perc = 1)]
  top25perc_cands <- LCV_scores[top25perc_ind == TRUE, .(ICPSR, Year, indicator_top_25perc = 1)]
  bottom25perc_cands <- LCV_scores[bottom25perc_ind == TRUE, .(ICPSR, Year, indicator_bottom_25perc = 1)]
  ...
  contribs <- merge.data.table(contribs, top10perc_cands,
                               by.x = c('ICPSR2', 'prev_year'),
                               by.y = c('ICPSR', 'Year'),
                               all.x = TRUE)
  contribs <- merge.data.table(contribs, bottom10perc_cands,
                               by.x = c('ICPSR2', 'prev_year'),
                               by.y = c('ICPSR', 'Year'),
                               all.x = TRUE)
  
  contribs <- merge.data.table(contribs, top25perc_cands,
                               by.x = c('ICPSR2', 'prev_year'),
                               by.y = c('ICPSR', 'Year'),
                               all.x = TRUE)
  contribs <- merge.data.table(contribs, bottom25perc_cands,
                               by.x = c('ICPSR2', 'prev_year'),
                               by.y = c('ICPSR', 'Year'),
                               all.x = TRUE)
  ...
  contribs <- contribs[, `:=`(TPD_cands = (TPD * indicator_cand * indicator_has_LCV_data),
                              ...
                              Donation_count_PACs = (Donation_count * indicator_PAC),
                              ######
                              TPD_PACs_above200 = (TPD_above200 * indicator_PAC),
                              TPD_PACs_below200 = (TPD_below200 * indicator_PAC),
                              ######
                              Donation_count_PACs_above200 = (Donation_count_above200 * indicator_PAC),
                              Donation_count_PACs_below200 = (Donation_count_below200 * indicator_PAC),
                              ###### BIG & SMALL AMOUNTS
                              TPD_top_10perc = (TPD * indicator_cand * indicator_top_10perc),
                              TPD_bottom_10perc = (TPD * indicator_cand * indicator_bottom_10perc),
                              TPD_top_25perc = (TPD * indicator_cand * indicator_top_25perc),
                              TPD_bottom_25perc = (TPD * indicator_cand * indicator_bottom_25perc),
                              ###### BIG & SMALL COUNTS
                              Donation_count_top_10perc = (Donation_count * indicator_cand  * indicator_top_10perc),
                              Donation_count_bottom_10perc = (Donation_count * indicator_cand * indicator_bottom_10perc),
                              Donation_count_top_25perc = (Donation_count * indicator_cand  * indicator_top_25perc),
                              Donation_count_bottom_25perc = (Donation_count * indicator_cand * indicator_bottom_25perc),
                              ###### GREEN PAC AMOUNTS & COUNTS (BIG & SMALL)
                              TPD_greenPAC = (TPD * indicator_greenPAC),
                              Donation_count_greenPAC = (Donation_count * indicator_greenPAC),
                              ###### SMALL AMOUNTS
                              TPD_top_10perc_below200 = (TPD_below200 * indicator_cand * indicator_top_10perc),
                              TPD_bottom_10perc_below200 = (TPD_below200 * indicator_cand * indicator_bottom_10perc),
                              TPD_top_25perc_below200 = (TPD_below200 * indicator_cand * indicator_top_25perc),
                              TPD_bottom_25perc_below200 = (TPD_below200 * indicator_cand * indicator_bottom_25perc),
                              ###### SMALL COUNTS
                              Donation_count_top_10perc_below200 = (Donation_count_below200 * indicator_cand * indicator_top_10perc),
                              Donation_count_bottom_10perc_below200 = (Donation_count_below200 * indicator_cand * indicator_bottom_10perc),
                              Donation_count_top_25perc_below200 = (Donation_count_below200 * indicator_cand * indicator_top_25perc),
                              Donation_count_bottom_25perc_below200 = (Donation_count_below200 * indicator_cand * indicator_bottom_25perc),
                              ###### GREEN PAC AMOUNTS & COUNTS (SMALL)
                              TPD_greenPAC_below200 = (TPD_below200 * indicator_greenPAC),
                              Donation_count_greenPAC_below200 = (Donation_count_below200 * indicator_greenPAC),
                              ###### BIG AMOUNTS
                              TPD_top_10perc_above200 = (TPD_above200 * indicator_cand * indicator_top_10perc),
                              TPD_bottom_10perc_above200 = (TPD_above200 * indicator_cand * indicator_bottom_10perc),
                              TPD_top_25perc_above200 = (TPD_above200 * indicator_cand * indicator_top_25perc),
                              TPD_bottom_25perc_above200 = (TPD_above200 * indicator_cand * indicator_bottom_25perc),
                              ###### BIG COUNTS
                              Donation_count_top_10perc_above200 = (Donation_count_above200 * indicator_cand * indicator_top_10perc),
                              Donation_count_bottom_10perc_above200 = (Donation_count_above200 * indicator_cand * indicator_bottom_10perc),
                              Donation_count_top_25perc_above200 = (Donation_count_above200 * indicator_cand * indicator_top_25perc),
                              Donation_count_bottom_25perc_above200 = (Donation_count_above200 * indicator_cand * indicator_bottom_25perc),
                              ###### GREEN PAC AMOUNTS & COUNTS (BIG)
                              TPD_greenPAC_above200 = (TPD_above200 * indicator_greenPAC),
                              Donation_count_greenPAC_above200 = (Donation_count_above200 * indicator_greenPAC)
                              )]
  ...
  contribs <- contribs[, c('prev_year',
                           ...
                           'indicator_top_10perc',
                           'indicator_bottom_10perc',
                           'indicator_top_25perc',
                           'indicator_bottom_25perc') := NULL]
  ...
  fwrite(contribs, glue('{cleaned}/zipquantiles_contribs_{cycles[i]}.csv'))
...
list_of_datasets_by_year <- list.files(path = glue('{cleaned}/'), pattern = 'zipquantiles_contribs_20*')
...
for(i in 1:length(list_of_datasets_by_year)) {
  ...
  contribs <- contribs[, c('TPD_PACs',
                           ...
                           'TPD_PACs_above200',
                           'TPD_PACs_below200',
                           'Donation_count_PACs_above200',
                           'Donation_count_PACs_below200',
                           'TPD_greenPAC',
                           'Donation_count_greenPAC',
                           'TPD_greenPAC_below200',
                           'TPD_greenPAC_above200',
                           'Donation_count_greenPAC_above200',
                           'Donation_count_greenPAC_below200'
                           ) := NULL]
...
full_df <- full_df[, .(tpd_cands = sum(tpd_cands, na.rm = TRUE),
                       ...
                       ######
                       #tpd_pacs = sum(tpd_pacs, na.rm = TRUE),
                       #donation_count_pacs = sum(donation_count_pacs, na.rm = TRUE),
                       ######
                       #tpd_pacs_above200 = sum(tpd_pacs_above200, na.rm = TRUE),
                       #tpd_pacs_below200 = sum(tpd_pacs_below200, na.rm = TRUE),
                       ######
                       #donation_count_pacs_above200 = sum(donation_count_pacs_above200, na.rm = TRUE),
                       #donation_count_pacs_below200 = sum(donation_count_pacs_below200, na.rm = TRUE),
                       ###### BIG & SMALL AMOUNTS
                       tpd_top_10perc = sum(tpd_top_10perc, na.rm = TRUE),
                       tpd_bottom_10perc = sum(tpd_bottom_10perc, na.rm = TRUE),
                       tpd_top_25perc = sum(tpd_top_25perc, na.rm = TRUE),
                       tpd_bottom_25perc = sum(tpd_bottom_25perc, na.rm = TRUE),
                       ###### BIG & SMALL COUNTS
                       donation_count_top_10perc = sum(donation_count_top_10perc, na.rm = TRUE),
                       donation_count_bottom_10perc = sum(donation_count_bottom_10perc, na.rm = TRUE),
                       donation_count_top_25perc = sum(donation_count_top_25perc, na.rm = TRUE),
                       donation_count_bottom_25perc = sum(donation_count_bottom_25perc, na.rm = TRUE),
                       ###### GREEN PAC AMOUNTS & COUNTS (BIG & SMALL)
                       #tpd_greenpac = sum(tpd_greenpac, na.rm = TRUE),
                       #donation_count_greenpac = sum(donation_count_greenpac, na.rm = TRUE),
                       ###### SMALL AMOUNTS
                       tpd_top_10perc_below200 = sum(tpd_top_10perc_below200, na.rm = TRUE),
                       tpd_bottom_10perc_below200 = sum(tpd_bottom_10perc_below200, na.rm = TRUE),
                       tpd_top_25perc_below200 = sum(tpd_top_25perc_below200, na.rm = TRUE),
                       tpd_bottom_25perc_below200 = sum(tpd_bottom_25perc_below200, na.rm = TRUE),
                       ###### SMALL COUNTS
                       donation_count_top_10perc_below2 = sum(donation_count_top_10perc_below2, na.rm = TRUE),
                       donation_count_bottom_10perc_bel = sum(donation_count_bottom_10perc_bel, na.rm = TRUE),
                       donation_count_top_25perc_below2 = sum(donation_count_top_25perc_below2, na.rm = TRUE),
                       donation_count_bottom_25perc_bel = sum(donation_count_bottom_25perc_bel, na.rm = TRUE),
                       ###### GREEN PAC AMOUNTS & COUNTS (SMALL)
                       #tpd_greenpac_below200 = sum(tpd_greenpac_below200, na.rm = TRUE),
                       #donation_count_greenpac_below200 = sum(donation_count_greenpac_below200, na.rm = TRUE),
                       ###### BIG AMOUNTS
                       tpd_top_10perc_above200 = sum(tpd_top_10perc_above200, na.rm = TRUE),
                       tpd_bottom_10perc_above200 = sum(tpd_bottom_10perc_above200, na.rm = TRUE),
                       tpd_top_25perc_above200 = sum(tpd_top_25perc_above200, na.rm = TRUE),
                       tpd_bottom_25perc_above200 = sum(tpd_bottom_25perc_above200, na.rm = TRUE),
                       ###### BIG COUNTS
                       donation_count_top_10perc_above2 = sum(donation_count_top_10perc_above2, na.rm = TRUE),
                       donation_count_bottom_10perc_abo = sum(donation_count_bottom_10perc_abo, na.rm = TRUE),
                       donation_count_top_25perc_above2 = sum(donation_count_top_25perc_above2, na.rm = TRUE),
                       donation_count_bottom_25perc_abo = sum(donation_count_bottom_25perc_abo, na.rm = TRUE),
                       ###### GREEN PAC AMOUNTS & COUNTS (BIG)
                       #tpd_greenpac_above200 = sum(tpd_greenpac_above200, na.rm = TRUE),
                       #donation_count_greenpac_above200 = sum(donation_count_greenpac_above200, na.rm = TRUE),
                       fips = first(fips)),
